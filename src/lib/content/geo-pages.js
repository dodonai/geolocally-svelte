export const geoPages = {
  florida: {
    ...
    heroTitle: "Florida customers move fast. Your website should say what you do faster.",
    heroBody:
      "If your business is hard to understand online, a clearer competitor gets the call first. GeoLocally builds focused landing pages for Florida service businesses so people can tell what you do, where you work, and how to contact you in seconds.",
    heroBullets: [
    ...
    sections: [
      {
        title: "Why this matters in Florida",
        paragraphs: [
          "Florida is crowded. Home services, dental, wellness, legal, insurance, auto, and hospitality businesses are all competing for the same local attention.",
          "That used to mean competing mostly for blue-link rankings. Now people compare faster.",
          "When customers ask detailed questions, Google pulls from websites, business listings, and whatever it can understand quickly. GeoLocally helps your business look clearer, more current, and easier to trust.",
        ],
        list: [
          "best dentist near me",
          "best plumber in Miami",
          "best med spa in Tampa",
          "best roof repair company in Orlando",
        ],
        listIntro: "Florida customers search like this:",
      },
      {
        title: "What GeoLocally builds for Florida businesses",
        paragraphs: [
          "GeoLocally builds a digital storefront around one goal: help customers understand who you are, what you do, and where you work without making them dig for it.",
        ],
        list: [
          "a focused landing page built around one clear offer",
          "copy that says what you do and where you work",
          "a custom animated explainer video",
          "clean structure for Google and modern search",
          "mobile-first design",
      ...
      },
      {
        ...
        paragraphs: [
          "GeoLocally works best for Florida businesses that rely on local trust and quick buying decisions.",
        ],
        list: [
          "plumbers",
          "HVAC companies",
        ...
        outro:
          "If your next customer usually finds you through search, referral, or comparison shopping, this page is for you.",
      },
      {
        title: "What makes this different from a normal website",
        paragraphs: [
          "A normal small-business website usually tries to do too much. Too many pages. Too much generic copy. Not enough clarity about what the business actually does.",
          "This is not a bloated website project. It is a sharper front door for a business that needs to be understood quickly.",
        ],
        list: [
          "one focused page",
        ...
        listIntro: "A GeoLocally storefront is different:",
      },
    ],
    process: [
      {
        title: "You send the business basics",
        body: "Business name, city, service category, website if you have one, and anything customers should know first.",
      },
      {
        title: "We build your storefront",
        body: "We write the page, shape the offer, create the video, and package everything into one clear storefront.",
      },
      {
        title: "You review and launch",
        body: "You review the final draft, approve it, and we help get it live.",
      },
    ],
    faqs: [
      {
        question: "Do I need to be in one specific Florida city?",
        answer:
          "No. This page is for Florida businesses statewide. If you serve one city, multiple cities, or a larger Florida region, the storefront can be structured around that footprint.",
      },
      {
        question: "Is this replacing my website?",
        answer:
          "Not necessarily. It can work as a focused storefront even if you already have a broader website.",
      },
      {
        question: "Do I need to understand AEO?",
        answer:
          "No. You do not need the acronym. You need a page that says what you do clearly and makes it easy for people to act.",
      },
      {
        question: "Can this work for a business with no website today?",
        answer: "Yes. That is one of the strongest use cases.",
      },
    ],
    finalCta: {
      title: "Florida is too competitive to stay vague online.",
      body: "Tell us what you do and where you serve. If GeoLocally can help, we'll show you the next step.",
    },
  },
  miami: {
    slug: "miami",
    ...
    heroTitle:
      "In Miami, the business that gets understood first gets contacted first.",
    heroBody:
      "Miami customers move fast. They search on mobile, compare quickly, and trust the business that looks clear, current, and easy to understand. GeoLocally builds Miami storefront pages that help local businesses explain the offer quickly and make the next step obvious.",
    heroBullets: [
      "Built for Miami search and mobile traffic",
      "Fast to understand",
      "One clear next step",
      "Starting at $499",
    ],
    sections: [
      {
        title: "Why Miami is different",
        paragraphs: [
          "Miami is not a low-attention market. It is a fast, visual, high-competition market where generic websites disappear.",
          "If your page is slow, vague, outdated, or written like every other agency template, customers move on.",
          "That pressure gets even stronger when search results summarize options instead of showing only links.",
        ],
        list: [
          "clear in seconds",
          "local in language",
          "strong on mobile",
          "built to communicate trust quickly",
        ],
        listIntro: "Miami businesses need a storefront that is:",
      },
      {
        title: "Best fit industries in Miami",
        paragraphs: ["This page is especially strong for Miami businesses in:"],
        list: [
          "dental and aesthetic services",
          "salons, med spas, and beauty businesses",
          "legal and professional services",
          "home services",
          "hospitality-adjacent local businesses",
          "auto services",
        ],
        outro:
          "If your market depends on local trust, fast impressions, and strong differentiation, a generic brochure site is not enough.",
      },
      {
        title: "What your Miami storefront includes",
        paragraphs: [
          "Your GeoLocally Miami page is built to answer the questions customers ask before they contact you:",
        ],
        list: [
          "who are you",
        ...
        outro:
          "We package that into one focused landing page, one custom animated explainer video, one clear city-aware landing asset, and one direct lead path into your intake process.",
      },
      {
        title: "Built for search clarity, not just pretty design",
        paragraphs: [
          "Design matters in Miami. But pretty alone does not make a business easy for Google or a customer to understand.",
          "This is why the page is called a storefront, not just a homepage.",
        ],
        list: [
          "clear presentation for human visitors",
          "strong structure for Google indexing",
          "page organization that helps search understand your business",
          "clear service and location language",
        ],
        listIntro: "GeoLocally is built around both:",
      },
    ],
    process: [
      {
        title: "You submit your details",
        body: "Tell us about your business, location, and offer.",
      },
      {
        title: "We build the draft",
        body: "We create the copy, structure, and video around a clear Miami positioning angle.",
      },
      {
        title: "You approve and launch",
        body: "You review it, approve it, and we prepare it to go live.",
      },
    ],
    faqs: [
      {
        question:
          "Can this work if I already have an Instagram page and referrals?",
        answer:
          "Yes. Referrals and Instagram help, but most people still look you up before they call.",
      },
      {
        question: "Will this feel too generic for Miami?",
        answer:
          "Not if the copy is built right. The goal is a page that still feels sharp, local, and specific without sounding inflated.",
      },
      {
        question: "Can I use this for one neighborhood or one service line?",
        answer: "Yes. A narrower page often converts better than a broad one.",
      },
      {
        question: "Do I need a full redesign of my whole brand first?",
        answer:
          "No. The storefront can launch with the current working brand system.",
      },
    ],
    finalCta: {
      title: "Miami customers do not wait for unclear businesses.",
  ...
  tampa: {
    ...
    heroTitle:
      "Tampa businesses do not need more website fluff. They need a clearer storefront.",
    heroBody:
      "If a Tampa customer finds you through search, your business should be easy to understand fast. GeoLocally builds focused landing pages for Tampa service businesses that need clearer positioning, stronger first impressions, and one clean path to contact.",
    heroBullets: [
      "Built for Tampa local businesses",
      "Designed for service-based conversion",
      "Fast, clear, mobile-first",
      "Starting at $499",
    ],
    sections: [
      {
        title: "Why this matters in Tampa",
        paragraphs: [
          'Tampa has the kind of competition where "good enough" online presence quietly loses.',
          "Your business may already be solid. The problem is not the service. The problem is that online, you may still look generic, fragmented, or hard to interpret.",
          "GeoLocally gives you a focused asset built to reduce that ambiguity.",
        ],
        list: [
          "local search",
        ...
        listIntro: "That hurts in:",
      },
      {
        title: "Best fit categories in Tampa",
        paragraphs: ["This page is a strong fit for:"],
        list: [
          "plumbers",
        ...
        outro:
          "If you serve a real local territory and depend on trust, speed, and search visibility, a storefront page can outperform a cluttered general website.",
      },
      {
        title: "What you get",
        paragraphs: [
          "Your Tampa storefront is designed to do four things well:",
        ],
        points: [
          {
            title: "Be understood",
            body: "Clear copy, clean service framing, and strong location signals.",
          },
          {
            title: "Build trust",
            body: "Modern presentation, strong structure, and a more professional first impression.",
          },
          {
            title: "Help search understand you faster",
            body: "Cleaner organization for Google and newer search tools.",
          },
          {
            title: "Drive action",
            body: "A single focused lead path instead of scattered navigation and weak calls to action.",
          },
        ],
      },
      {
        ...
        paragraphs: [
          "GeoLocally is not a bloated website redesign, a generic content dump, a slideshow pretending to be a marketing asset, or a long agency engagement.",
          "It is a practical storefront for a business that needs to get found and contacted more clearly.",
        ],
      },
    ],
    process: [
      {
        ...
        body: "Business info, city, category, and current site if you have one.",
      },
      {
        title: "We build the page and video",
        body: "We turn that into a clear, service-first digital storefront.",
      },
      {
        title: "You review and approve",
        body: "Nothing is treated as final until you approve the direction.",
      },
    ],
    faqs: [
      {
        ...
        answer:
          "This can still work as a sharper landing page focused on one market, one service set, or one conversion path.",
      },
      {
        question: "What if I serve suburbs around Tampa too?",
        answer:
          "That is fine. The page can be structured around Tampa plus the nearby service area you actually cover.",
      },
      {
        question: "Does this replace SEO?",
        answer:
          "No. It gives you a clearer page that supports SEO and makes your business easier to understand online.",
      },
      {
        question: "Can this help if I rely mostly on referrals today?",
        answer:
          "Yes. Referral businesses still get searched before someone calls.",
      },
    ],
    finalCta: {
      title:
        "If your business is harder to understand than your competitor, you lose the click.",
